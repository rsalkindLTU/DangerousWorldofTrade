...
(function dartProgram() {
  ...
  W = {
    ...
    _EventStreamSubscription$: function(_target, _eventType, onData, _useCapture, $T) {
      ...
      if (t1 != null && true)
        C.WebSocket_methods.addEventListener$3(_target, _eventType, t1, false);
  ...
  N = {Form: function Form() {
    }, Startup: function Startup(t0, t1) {
      var _ = this;
      _._user_reference = _._formats$_commander_name = null;
      _.header = t0;
      _.content = t1;
    }},
  M = {User: function User() {
      this._current_credits = this._commander_name = null;
    }, websocket_client: function websocket_client(t0) {
      this._socket = t0;
    }, websocket_client__listen_closure: function websocket_client__listen_closure(t0, t1) {
      this.$this = t0;
      this.firstMsg = t1;
    }, websocket_client__listen_closure0: function websocket_client__listen_closure0() {
    }, websocket_client__listen_closure1: function websocket_client__listen_closure1() {
    }, websocket_client__listen_closure2: function websocket_client__listen_closure2() {
    }},
  Z = {
    main: function() {
      var guest, user_json, t2, t3, t4, site_form, item, item0, _null = null,
        t1 = W.WebSocket_WebSocket("ws://localhost:4502");
      P.print("Connecting to ws://localhost:4502. . . ");
      new M.websocket_client(t1)._listen$1("Hello?");
      t1 = C.C_JsonCodec.encode$1(P.LinkedHashMap_LinkedHashMap$_literal(["commander", "Caddox", "credits", 182319], P.String, P.Object));
      guest = new M.User();
      P.print("Creating user object. . .");
      if (t1 === "" || false) {
        t1 = guest._commander_name = "";
        guest._current_credits = 0;
      } else {
        user_json = C.C_JsonCodec.decode$2$reviver(0, t1, _null);
        t1 = J.getInterceptor$asx(user_json);
        t2 = guest._commander_name = H.stringTypeCheck(t1.$index(user_json, "commander"));
        guest._current_credits = H.numTypeCheck(t1.$index(user_json, "credits"));
        t1 = t2;
      }
      t2 = document;
      t3 = t2.querySelector(".header");
      t4 = t2.querySelector(".content");
      t2.querySelector("footer");
      site_form = new N.Startup(t3, t4);
      site_form._formats$_commander_name = t1;
      site_form._user_reference = guest;
      J.get$children$x(site_form.header).clear$0(0);
      t1 = "Hello Commander " + H.S(site_form._formats$_commander_name) + "!";
      item = H.interceptedTypeCheck(W._ElementFactoryProvider_createElement_tag("p", _null), "$isElement");
      item.textContent = t1;
      J.get$children$x(site_form.header).add$1(0, item);
      J.get$children$x(site_form.content).clear$0(0);
      item = H.interceptedTypeCheck(W._ElementFactoryProvider_createElement_tag("p", _null), "$isElement");
      item.textContent = "Looks like we don't have info for you!";
      t1 = "You currently have " + H.S(site_form._user_reference._current_credits) + " credits.";
      item0 = H.interceptedTypeCheck(W._ElementFactoryProvider_createElement_tag("p", _null), "$isElement");
      item0.textContent = t1;
      J.get$children$x(site_form.content).add$1(0, item);
      J.get$children$x(site_form.content).add$1(0, item0);
    }
  };
  var holders = [C, H, J, P, W, N, M, Z];
  ...
  J.JSString.prototype = {
    ...
    $index: function(receiver, index) {
      H.intTypeCheck(index);
      if (index.$ge(index, receiver.length) || index.$lt(index, 0))
        throw H.wrapException(H.diagnoseIndexError(receiver, index));
      return receiver[index];
    },
    $isString: 1
  ...
  P.convertNativePromiseToDartFuture_closure0.prototype = {
    call$1: function(result) {
      var error = result == null ? new P.NullThrownError() : result,
  ...
  P.FilteredElementList.prototype = {
    ...
    insert$2: function(_, index, value) {
      var element,
        t1 = this.get$_html_common$_iterable().__internal$_iterable;
      if (index === t1.get$length(t1))
        this._childNodes._this.appendChild(value);
      else {
        t1 = this.get$_html_common$_iterable();
        element = t1._f.call$1(t1.__internal$_iterable.elementAt$1(0, index));
  ...
  N.Startup.prototype = {};
  M.User.prototype = {};
  M.websocket_client.prototype = {
    _listen$1: function(firstMsg) {
      var t4,
        t1 = this._socket,
        t2 = W.Event,
        t3 = {func: 1, ret: -1, args: [t2]};
      W._EventStreamSubscription$(t1, "open", H.functionTypeCheck(new M.websocket_client__listen_closure(this, firstMsg), t3), false, t2);
      t4 = W.CloseEvent;
      W._EventStreamSubscription$(t1, "close", H.functionTypeCheck(new M.websocket_client__listen_closure0(), {func: 1, ret: -1, args: [t4]}), false, t4);
      W._EventStreamSubscription$(t1, "error", H.functionTypeCheck(new M.websocket_client__listen_closure1(), t3), false, t2);
      t2 = W.MessageEvent;
      W._EventStreamSubscription$(t1, "message", H.functionTypeCheck(new M.websocket_client__listen_closure2(), {func: 1, ret: -1, args: [t2]}), false, t2);
    }
  };
  M.websocket_client__listen_closure.prototype = {
    call$1: function(e) {
      var t1;
      P.print("Connected!");
      t1 = this.firstMsg;
      P.print("==> " + t1);
      this.$this._socket.send(t1);
    },
    $signature: 16
  };
  M.websocket_client__listen_closure0.prototype = {
    call$1: function(_) {
      H.interceptedTypeCheck(_, "$isCloseEvent");
      return P.print("Goodbye!");
    },
    $signature: 17
  };
  M.websocket_client__listen_closure1.prototype = {
    call$1: function(_) {
      return P.print("Error opening connection :(");
    },
    $signature: 18
  };
  M.websocket_client__listen_closure2.prototype = {
    call$1: function(e) {
      var t1, t2, footerList, newItem;
      H.interceptedTypeCheck(e, "$isMessageEvent");
      P.print("<== " + H.S(new P._AcceptStructuredCloneDart2Js([], []).convertNativeToDart_AcceptStructuredClone$2$mustCopy(e.data, true)));
      t1 = H.stringTypeCheck(new P._AcceptStructuredCloneDart2Js([], []).convertNativeToDart_AcceptStructuredClone$2$mustCopy(e.data, true));
      t2 = document;
      footerList = t2.querySelector(".footer");
      newItem = t2.createElement("ul");
      newItem.textContent = t1;
      J.get$children$x(footerList).insert$2(0, 0, newItem);
    },
    $signature: 19
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(P.Object, [H.JS_CONST, J.Interceptor, J.ArrayIterator, P.Iterable, H.ListIterator, P.Iterator, H.FixedLengthListMixin, H.TypeErrorDecoder, P.Error, H.Closure, H._StackTrace, P.MapMixin, H.LinkedHashMapCell, H.LinkedHashMapKeyIterator, P._TimerImpl, P._Completer, P._FutureListener, P._Future, P._AsyncCallbackEntry, P.Stream, P.StreamSubscription, P.StreamTransformerBase, P.AsyncError, P._Zone, P._ListBase_Object_ListMixin, P.ListMixin, P.Codec, P._JsonStringifier, P.bool, P.DateTime, P.num, P.StackOverflowError, P._Exception, P.FormatException, P.List, P.Null, P.StackTrace, P.String, P.StringBuffer, W.ImmutableListMixin, W.FixedSizeListIterator, P._AcceptStructuredClone, N.Form, M.User, M.websocket_client]);
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JavaScriptObject, J.JSArray, J.JSNumber, J.JSString, H.NativeTypedData, W.EventTarget, W.Event, W.DomException, W._HtmlCollection_Interceptor_ListMixin, W._NodeList_Interceptor_ListMixin]);
  ...
  var init = {mangledGlobalNames: {int: "int", double: "double", num: "num", String: "String", bool: "bool", Null: "Null", List: "List"}, mangledNames: {}, getTypeFromName: getGlobalFromName, metadata: [], types: [{func: 1, ret: P.Null}, {func: 1, ret: -1}, {func: 1, args: [,]}, {func: 1, ret: -1, args: [{func: 1, ret: -1}]}, {func: 1, ret: P.Null, args: [,]}, {func: 1, ret: P.Null, args: [,,]}, {func: 1, ret: -1, args: [,]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, ret: P.Null, args: [{func: 1, ret: -1}]}, {func: 1, ret: P.Null, args: [,], opt: [P.StackTrace]}, {func: 1, ret: [P._Future,,], args: [,]}, {func: 1, args: [W.Event]}, {func: 1, args: [,,]}, {func: 1, ret: P.bool, args: [W.Node]}, {func: 1, ret: W.Element, args: [W.Node]}, {func: 1, ret: P.Null, args: [W.Event]}, {func: 1, ret: -1, args: [W.CloseEvent]}, {func: 1, ret: -1, args: [W.Event]}, {func: 1, ret: P.Null, args: [W.MessageEvent]}], interceptorsByTag: null, leafTags: null};
  (function constants() {
